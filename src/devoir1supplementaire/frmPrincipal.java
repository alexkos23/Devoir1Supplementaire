...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void btnNbAnneesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNbAnneesMouseClicked
        ...
        // A vous de jouer
        float benefice=31000000;
        float recette=31000000;
        int annee=1;
        float pourcentage=(float) 0.80;
        
        while(benefice < 150000000){
            recette = recette * pourcentage ;
            benefice = benefice + recette  ;
            annee = annee +1;
        }
        lblNbSemaines.setText(String.valueOf(annee) + " années");
    ...
    private void btnCalculerPrimeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCalculerPrimeMouseClicked
        ...
        if(txtNbBugs.getText().compareTo("")==0){
            JOptionPane.showMessageDialog(this, "Veuillez saisir un nombre de bugs");
        }
        else if(txtNbAnnees.getText().compareTo("")==0)
        {
           JOptionPane.showMessageDialog(this, "Veuillez saisir un nombre d'années"); 
            ...
            float primeRdmt = (float) (Integer.parseInt(txtNbBugs.getText())*0.04);
            if(primeRdmt>400){
                primeRdmt = 400;
            }
            else{
            ...
            float primeAncien=300;
            if(Integer.parseInt(txtNbAnnees.getText())>4){
                int ans= Integer.parseInt(txtNbAnnees.getText()) -4;
                primeAncien=primeAncien+30*ans;
            }
            else{
                primeAncien=primeAncien;
            }
            float prime = primeRdmt+primeAncien;
            lblPrime.setText("Prime: "+String.valueOf(prime)+" euros");
        }
